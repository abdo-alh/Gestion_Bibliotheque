...
// Returns the private 'App\Repository\BookLikeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BookLikeRepository.php';

return $this->privates['App\Repository\BookLikeRepository'] = new \App\Repository\BookLikeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
