...
return $this->services['App\Controller\AdminController'] = new \App\Controller\AdminController(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
